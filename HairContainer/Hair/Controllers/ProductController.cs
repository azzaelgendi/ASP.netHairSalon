...
namespace Hair.Controllers
{
    public class ProductController : Controller
    {
        ...
        public ProductController(HairContext context)
        {
            _context = context;
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ProductId,IsProcedure,Name,Description,RetailPrice,WholesalePrice,ProcedureMinutes")] Product product)
        {
